...
type CreateAlertRequest struct {
	...
	// How often or when to check sources for this alert, specified as a cron expression. Examples: '*_/15 * * * *' (every 15 minutes), '0 * * * *' (hourly), '0 9 * * *' (daily at 9am), '0 9 * * 1' (Mondays at 9am).  See https://crontab.run/ for more examples.
