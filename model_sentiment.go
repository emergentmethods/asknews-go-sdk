...
func (dst *Sentiment) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("data failed to match schemas in anyOf(Sentiment)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src Sentiment) MarshalJSON() ([]byte, error) {
	if src.Float32 != nil {
