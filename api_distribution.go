...
// Filter by full-text opt-in status
func (r ApiFindDomainsRequest) FullText(fullText bool) ApiFindDomainsRequest {
	r.fullText = &fullText
	return r
}
...
func (a *DistributionAPIService) FindDomainsExecute(r ApiFindDomainsRequest) (*PaginatedResponseReadDomainResponse, *http.Response, error) {
	...
	if r.fullText != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "full_text", r.fullText, "form", "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
type ApiGetDomainMetricsRequest struct {
	ctx context.Context
	ApiService *DistributionAPIService
	domainNames *[]string
	startDate *int32
...
// Domain names to filter by
func (r ApiGetDomainMetricsRequest) DomainNames(domainNames []string) ApiGetDomainMetricsRequest {
	r.domainNames = &domainNames
	return r
}

// Start date to filter by (timestamp in seconds since epoch)
func (r ApiGetDomainMetricsRequest) StartDate(startDate int32) ApiGetDomainMetricsRequest {
	r.startDate = &startDate
	return r
}

// End date to filter by (timestamp in seconds since epoch)
func (r ApiGetDomainMetricsRequest) EndDate(endDate int32) ApiGetDomainMetricsRequest {
	r.endDate = &endDate
	return r
}

func (r ApiGetDomainMetricsRequest) Execute() (*DomainMetricsResponse, *http.Response, error) {
	return r.ApiService.GetDomainMetricsExecute(r)
}

/*
GetDomainMetrics Get raw publisher metric event counts for domains
...
real event; revenue-share weighting stays in the distribution service.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetDomainMetricsRequest
*/
func (a *DistributionAPIService) GetDomainMetrics(ctx context.Context) ApiGetDomainMetricsRequest {
	return ApiGetDomainMetricsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *DistributionAPIService) GetDomainMetricsExecute(r ApiGetDomainMetricsRequest) (*DomainMetricsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DomainMetricsResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DistributionAPIService.GetDomainMetrics")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/distribution/stats/metrics"
...
type ApiGetDomainMetricsTimeseriesRequest struct {
	ctx context.Context
	ApiService *DistributionAPIService
	domainNames *[]string
	startDate *int32
...
// Domain names to filter by
func (r ApiGetDomainMetricsTimeseriesRequest) DomainNames(domainNames []string) ApiGetDomainMetricsTimeseriesRequest {
	r.domainNames = &domainNames
	return r
}

// Start date to filter by (timestamp in seconds since epoch)
func (r ApiGetDomainMetricsTimeseriesRequest) StartDate(startDate int32) ApiGetDomainMetricsTimeseriesRequest {
	r.startDate = &startDate
	return r
}

// End date to filter by (timestamp in seconds since epoch)
func (r ApiGetDomainMetricsTimeseriesRequest) EndDate(endDate int32) ApiGetDomainMetricsTimeseriesRequest {
	r.endDate = &endDate
	return r
}

func (r ApiGetDomainMetricsTimeseriesRequest) Execute() (*DomainMetricsTimeWindowResponse, *http.Response, error) {
	return r.ApiService.GetDomainMetricsTimeseriesExecute(r)
}

/*
GetDomainMetricsTimeseries Get raw publisher metric event counts per day for domains

Get raw (unweighted) surface, citation, full_text and grounded publisher
metric event counts per day for a list of domains in a time period.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetDomainMetricsTimeseriesRequest
*/
func (a *DistributionAPIService) GetDomainMetricsTimeseries(ctx context.Context) ApiGetDomainMetricsTimeseriesRequest {
	return ApiGetDomainMetricsTimeseriesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return DomainMetricsTimeWindowResponse
func (a *DistributionAPIService) GetDomainMetricsTimeseriesExecute(r ApiGetDomainMetricsTimeseriesRequest) (*DomainMetricsTimeWindowResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DomainMetricsTimeWindowResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DistributionAPIService.GetDomainMetricsTimeseries")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/distribution/stats/metrics_timeseries"
...
func (r ApiTopNArticlesByHitsRequest) Page(page int32) ApiTopNArticlesByHitsRequest {
	r.page = &page
	return r
}
...
// Page number (1-based; page size &#x3D; limit)
func (r ApiTopNArticlesForDomainsRequest) Page(page int32) ApiTopNArticlesForDomainsRequest {
	r.page = &page
	return r
}
