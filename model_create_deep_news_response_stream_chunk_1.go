...
// checks if the CreateDeepNewsResponseStreamChunk1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateDeepNewsResponseStreamChunk1{}

// CreateDeepNewsResponseStreamChunk1 struct for CreateDeepNewsResponseStreamChunk1
type CreateDeepNewsResponseStreamChunk1 struct {
	Id string `json:"id"`
	Created int32 `json:"created"`
	Object *string `json:"object,omitempty"`
	Model *string `json:"model,omitempty"`
	Usage CreateDeepNewsResponseUsage1 `json:"usage"`
	Choices []CreateDeepNewsResponseStreamChunkChoice1 `json:"choices"`
	AdditionalProperties map[string]interface{}
}

type _CreateDeepNewsResponseStreamChunk1 CreateDeepNewsResponseStreamChunk1
...
func NewCreateDeepNewsResponseStreamChunk1(id string, created int32, usage CreateDeepNewsResponseUsage1, choices []CreateDeepNewsResponseStreamChunkChoice1) *CreateDeepNewsResponseStreamChunk1 {
	this := CreateDeepNewsResponseStreamChunk1{}
	this.Id = id
...
func (o *CreateDeepNewsResponseStreamChunk1) GetUsage() CreateDeepNewsResponseUsage1 {
	if o == nil {
		var ret CreateDeepNewsResponseUsage1
		return ret
	}
...
func (o *CreateDeepNewsResponseStreamChunk1) GetChoices() []CreateDeepNewsResponseStreamChunkChoice1 {
	if o == nil {
		var ret []CreateDeepNewsResponseStreamChunkChoice1
		return ret
	}
...
func (o CreateDeepNewsResponseStreamChunk1) MarshalJSON() ([]byte, error) {
...
func (o CreateDeepNewsResponseStreamChunk1) ToMap() (map[string]interface{}, error) {
...
func (o *CreateDeepNewsResponseStreamChunk1) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateDeepNewsResponseStreamChunk1 := _CreateDeepNewsResponseStreamChunk1{}

	err = json.Unmarshal(data, &varCreateDeepNewsResponseStreamChunk1)

	if err != nil {
		return err
	}

	*o = CreateDeepNewsResponseStreamChunk1(varCreateDeepNewsResponseStreamChunk1)
...
type NullableCreateDeepNewsResponseStreamChunk1 struct {
	value *CreateDeepNewsResponseStreamChunk1
	isSet bool
}

func (v NullableCreateDeepNewsResponseStreamChunk1) Get() *CreateDeepNewsResponseStreamChunk1 {
	return v.value
}

func (v *NullableCreateDeepNewsResponseStreamChunk1) Set(val *CreateDeepNewsResponseStreamChunk1) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateDeepNewsResponseStreamChunk1) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateDeepNewsResponseStreamChunk1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateDeepNewsResponseStreamChunk1(val *CreateDeepNewsResponseStreamChunk1) *NullableCreateDeepNewsResponseStreamChunk1 {
	return &NullableCreateDeepNewsResponseStreamChunk1{value: val, isSet: true}
}

func (v NullableCreateDeepNewsResponseStreamChunk1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateDeepNewsResponseStreamChunk1) UnmarshalJSON(src []byte) error {
	v.isSet = true
