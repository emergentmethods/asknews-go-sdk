...
type CreateDeepNewsRequest struct {
	...
	EnableSourcePruning *bool `json:"enable_source_pruning,omitempty"`
	CutoffDatetime *CutoffDatetime `json:"cutoff_datetime,omitempty"`
...
func NewCreateDeepNewsRequest(messages []CreateDeepNewsRequestMessage) *CreateDeepNewsRequest {
	...
	var model CreateDeepNewsRequestModel
	this.Model = &model
	...
	var engine string = "v1.5"
	this.Engine = &engine
	var enableSourcePruning bool = false
	this.EnableSourcePruning = &enableSourcePruning
	return &this
}
...
// GetEnableSourcePruning returns the EnableSourcePruning field value if set, zero value otherwise.
func (o *CreateDeepNewsRequest) GetEnableSourcePruning() bool {
	if o == nil || IsNil(o.EnableSourcePruning) {
		var ret bool
		return ret
	}
	return *o.EnableSourcePruning
}

// GetEnableSourcePruningOk returns a tuple with the EnableSourcePruning field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CreateDeepNewsRequest) GetEnableSourcePruningOk() (*bool, bool) {
	if o == nil || IsNil(o.EnableSourcePruning) {
		return nil, false
	}
	return o.EnableSourcePruning, true
}
...
// SetEnableSourcePruning gets a reference to the given bool and assigns it to the EnableSourcePruning field.
func (o *CreateDeepNewsRequest) SetEnableSourcePruning(v bool) {
	o.EnableSourcePruning = &v
}

// GetCutoffDatetime returns the CutoffDatetime field value if set, zero value otherwise.
func (o *CreateDeepNewsRequest) GetCutoffDatetime() CutoffDatetime {
	if o == nil || IsNil(o.CutoffDatetime) {
		var ret CutoffDatetime
		return ret
	}
	return *o.CutoffDatetime
}

// GetCutoffDatetimeOk returns a tuple with the CutoffDatetime field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CreateDeepNewsRequest) GetCutoffDatetimeOk() (*CutoffDatetime, bool) {
	if o == nil || IsNil(o.CutoffDatetime) {
		return nil, false
	}
	return o.CutoffDatetime, true
}
...
// SetCutoffDatetime gets a reference to the given CutoffDatetime and assigns it to the CutoffDatetime field.
...
func (o CreateDeepNewsRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.EnableSourcePruning) {
		toSerialize["enable_source_pruning"] = o.EnableSourcePruning
	}
	if !IsNil(o.CutoffDatetime) {
		toSerialize["cutoff_datetime"] = o.CutoffDatetime
	}
...
func (o *CreateDeepNewsRequest) UnmarshalJSON(data []byte) (err error) {
	...
	*o = CreateDeepNewsRequest(varCreateDeepNewsRequest)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "enable_source_pruning")
		delete(additionalProperties, "cutoff_datetime")
