...
func (o *EmailParams) GetAsknewsWatermark() bool {
...
// and a boolean to check if the value has been set.
func (o *EmailParams) GetAsknewsWatermarkOk() (*bool, bool) {
	if o == nil || IsNil(o.AsknewsWatermark) {
		return nil, false
	}
...
func (o *EmailParams) HasAsknewsWatermark() bool {
	if o != nil && !IsNil(o.AsknewsWatermark) {
		return true
	}
...
func (o *EmailParams) SetAsknewsWatermark(v bool) {
