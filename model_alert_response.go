...
type AlertResponse struct {
	...
	Report NullableReport `json:"report,omitempty"`
	...
	SeatId NullableString `json:"seat_id,omitempty"`
...
// SetReport gets a reference to the given NullableReport and assigns it to the Report field.
func (o *AlertResponse) SetReport(v Report) {
	o.Report.Set(&v)
}
// SetReportNil sets the value for Report to be an explicit nil
func (o *AlertResponse) SetReportNil() {
	o.Report.Set(nil)
}
...
func (o *AlertResponse) SetAlertTypeNil() {
	o.AlertType.Set(nil)
}
...
func (o *AlertResponse) SetTitleNil() {
	o.Title.Set(nil)
}
...
// GetSeatId returns the SeatId field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *AlertResponse) GetSeatId() string {
	if o == nil || IsNil(o.SeatId.Get()) {
		var ret string
		return ret
	}
	return *o.SeatId.Get()
...
// SetSeatId gets a reference to the given NullableString and assigns it to the SeatId field.
func (o *AlertResponse) SetSeatId(v string) {
	o.SeatId.Set(&v)
}
// SetSeatIdNil sets the value for SeatId to be an explicit nil
func (o *AlertResponse) SetSeatIdNil() {
	o.SeatId.Set(nil)
}
...
func (o *AlertResponse) SetApiKeyIdNil() {
	o.ApiKeyId.Set(nil)
}
...
func (o AlertResponse) ToMap() (map[string]interface{}, error) {
	...
	if o.SeatId.IsSet() {
		toSerialize["seat_id"] = o.SeatId.Get()
	}
	if o.ApiKeyId.IsSet() {
...
func (o *AlertResponse) UnmarshalJSON(data []byte) (err error) {
	...
	*o = AlertResponse(varAlertResponse)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "seat_id")
