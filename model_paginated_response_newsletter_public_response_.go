...
// checks if the PaginatedResponseNewsletterPublicResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedResponseNewsletterPublicResponse{}

// PaginatedResponseNewsletterPublicResponse struct for PaginatedResponseNewsletterPublicResponse
type PaginatedResponseNewsletterPublicResponse struct {
	Items []NewsletterPublicResponse `json:"items"`
...
type _PaginatedResponseNewsletterPublicResponse PaginatedResponseNewsletterPublicResponse
...
func NewPaginatedResponseNewsletterPublicResponse(items []NewsletterPublicResponse, count int32, nextPage NullableInt32, previousPage NullableInt32) *PaginatedResponseNewsletterPublicResponse {
	this := PaginatedResponseNewsletterPublicResponse{}
	this.Items = items
	this.Count = count
...
func (o *PaginatedResponseNewsletterPublicResponse) GetItems() []NewsletterPublicResponse {
	if o == nil {
		var ret []NewsletterPublicResponse
		return ret
	}
...
func (o PaginatedResponseNewsletterPublicResponse) MarshalJSON() ([]byte, error) {
...
func (o PaginatedResponseNewsletterPublicResponse) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedResponseNewsletterPublicResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedResponseNewsletterPublicResponse := _PaginatedResponseNewsletterPublicResponse{}

	err = json.Unmarshal(data, &varPaginatedResponseNewsletterPublicResponse)

	if err != nil {
		return err
	}

	*o = PaginatedResponseNewsletterPublicResponse(varPaginatedResponseNewsletterPublicResponse)
...
type NullablePaginatedResponseNewsletterPublicResponse struct {
	value *PaginatedResponseNewsletterPublicResponse
	isSet bool
}

func (v NullablePaginatedResponseNewsletterPublicResponse) Get() *PaginatedResponseNewsletterPublicResponse {
	return v.value
}

func (v *NullablePaginatedResponseNewsletterPublicResponse) Set(val *PaginatedResponseNewsletterPublicResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedResponseNewsletterPublicResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedResponseNewsletterPublicResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedResponseNewsletterPublicResponse(val *PaginatedResponseNewsletterPublicResponse) *NullablePaginatedResponseNewsletterPublicResponse {
	return &NullablePaginatedResponseNewsletterPublicResponse{value: val, isSet: true}
}

func (v NullablePaginatedResponseNewsletterPublicResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedResponseNewsletterPublicResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
