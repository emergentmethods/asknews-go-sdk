...
func (r ApiGetArticlesRequest) FullText(fullText bool) ApiGetArticlesRequest {
	r.fullText = &fullText
	return r
}
...
func (r ApiSearchNewsRequest) Podcasts(podcasts string) ApiSearchNewsRequest {
	r.podcasts = &podcasts
	return r
}
...
func (r ApiSearchNewsRequest) TryCache(tryCache string) ApiSearchNewsRequest {
	r.tryCache = &tryCache
	return r
}
...
func (r ApiSearchNewsRequest) GeoLat(geoLat float32) ApiSearchNewsRequest {
	r.geoLat = &geoLat
	return r
}

// Longitude for geo-radius filter. Must be provided together with geo_lat and geo_radius.
func (r ApiSearchNewsRequest) GeoLon(geoLon float32) ApiSearchNewsRequest {
	r.geoLon = &geoLon
	return r
}

// Radius in meters for geo-radius filter. Must be provided together with geo_lat and geo_lon.
func (r ApiSearchNewsRequest) GeoRadius(geoRadius float32) ApiSearchNewsRequest {
	r.geoRadius = &geoRadius
	return r
}
...
func (r ApiSearchNewsRequest) GeoPolygon(geoPolygon string) ApiSearchNewsRequest {
	r.geoPolygon = &geoPolygon
	return r
}
...
func (a *NewsAPIService) SearchNewsExecute(r ApiSearchNewsRequest) (*SearchResponse, *http.Response, error) {
	...
	if r.podcasts != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "podcasts", r.podcasts, "form", "")
	} else {
		var defaultValue string = "include"
		r.podcasts = &defaultValue
	}
	if r.pageRank != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "page_rank", r.pageRank, "form", "")
	}
	...
	if r.tryCache != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "try_cache", r.tryCache, "form", "")
	}
	if r.geoLat != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "geo_lat", r.geoLat, "form", "")
	}
	if r.geoLon != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "geo_lon", r.geoLon, "form", "")
	}
	if r.geoRadius != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "geo_radius", r.geoRadius, "form", "")
	}
	if r.geoPolygon != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "geo_polygon", r.geoPolygon, "form", "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
