...
type UpdateAlertRequest struct {
	...
	Report NullableReport2 `json:"report,omitempty"`
...
func (o *UpdateAlertRequest) SetAlertTypeNil() {
	o.AlertType.Set(nil)
}
...
// SetReport gets a reference to the given NullableReport2 and assigns it to the Report field.
