...
type UpdateAlertRequest struct {
	...
	Report NullableCreateAlertRequestReport `json:"report,omitempty"`
...
func (o *UpdateAlertRequest) GetReport() CreateAlertRequestReport {
	if o == nil || IsNil(o.Report.Get()) {
		var ret CreateAlertRequestReport
		return ret
	}
	return *o.Report.Get()
}
...
// SetReport gets a reference to the given NullableCreateAlertRequestReport and assigns it to the Report field.
