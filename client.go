...
// APIClient manages communication with the AskNews API API v0.24.66
...
type APIClient struct {
	...
	AutofilterAPI *AutofilterAPIService

	ByokAPI *ByokAPIService
	...
	IndexUrlsAPI *IndexUrlsAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.AutofilterAPI = (*AutofilterAPIService)(&c.common)
	...
	c.IndexUrlsAPI = (*IndexUrlsAPIService)(&c.common)
	...
	c.StoriesAPI = (*StoriesAPIService)(&c.common)
		...
		switch v.Kind() {
			...
			case reflect.Struct:
				...
				if t, ok := obj.(json.Marshaler); ok {
					...
					if err == nil {
						if jsonBytes == nil {
							return // no value set in anyOf type, skip param
						}
