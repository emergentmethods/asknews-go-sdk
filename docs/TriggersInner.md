...
### NewTriggersInnerWithDefaults

`func NewTriggersInnerWithDefaults() *TriggersInner`

NewTriggersInnerWithDefaults instantiates a new TriggersInner object
This constructor will only assign default values to properties that have it defined,
but it doesn't guarantee that properties required by API are set

### GetAction

`func (o *TriggersInner) GetAction() string`

GetAction returns the Action field if non-nil, zero value otherwise.

### GetActionOk

`func (o *TriggersInner) GetActionOk() (*string, bool)`
...
`func (o *TriggersInner) SetAction(v string)`

SetAction sets Action field to given value.

### HasAction

`func (o *TriggersInner) HasAction() bool`
